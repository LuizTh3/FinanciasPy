    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.CardGroup([
                dbc.Card([
                    html.Legend('Saldo'),
                    html.H5('R$ 1000.00', id='p-saldo-dashboard', style={}),
        ...
        # =========  Receitas  =========== #
            ...
            dbc.CardGroup([
                dbc.Card([
                    ...
                    html.H5('R$ 500.00', id='p-receita-dashboard', style={}),
                ], style={'padding-left': '20px','padding-top': '10px'}),
                dbc.Card(
        ...
        # =========  Despesas  =========== #
            ...
            dbc.CardGroup([
                dbc.Card([
                    ...
                    html.H5('R$ 700.00', id='p-despesa-dashboard', style={}),
                ], style={'padding-left': '20px','padding-top': '10px'}),
                dbc.Card(
...
def grap2_show(data_receita, data_despesa, receita, despesa, start_date, end_date):
    ...
    df_final[(df_final['Data'] >= start_date) & (df_final['Data'] <= end_date)]
